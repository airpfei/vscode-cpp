...
adb push /Users/pengfei/Library/Android/sdk/lldb/3.1/android/arm64-v8a/lldb-server /data/local/tmp/lldb/bin/
adb push /Users/pengfei/Library/Android/sdk/lldb/3.1/android/start_lldb_server.sh /data/local/tmp/lldb/bin/
